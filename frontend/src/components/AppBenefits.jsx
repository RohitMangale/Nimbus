    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="w-16 bg-indigo-600 flex flex-col items-center py-4 text-white">
        ...
        <nav className="flex flex-col gap-6 items-center flex-1">
          {[Grid, Package, Search, Tags, Package, ChevronRight].map(
            (Icon, index) => (
              <button
                key={index}
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-2 mt-6">
            ...
            <Select
              ...
              defaultValue="20"
              onChange={(value) =>
                console.log(`Show ${value} items per page`)
              }
            />
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-md p-4 text-center">
                  ...
                  <Input type="file" accept=".xlsx, .xls" className="mt-2" />
                </div>
                ...
                <div>
                  ...
                  <Select
                    options={["All Items", "Category 1", "Category 2"]}
              ...
              <div className="flex justify-end mt-6 gap-2">
                ...
                <Button
                  onClick={() => {
                    // TODO: Implement add item action (e.g. call API)
